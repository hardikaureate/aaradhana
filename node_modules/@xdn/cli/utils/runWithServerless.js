...
module.exports = async function runWithServerless(dir) {
  ...
  process.env.XDN_DEPLOYMENT_TYPE = 'AWS';
  process.env.NODE_ENV = 'production';
  process.env.XDN_CACHE = 'true';
  process.env.XDN_LOCAL = 'true'; // this turns off the wrapping of stdout, stderr

  process.env.XDN_IMAGE_OPTIMIZER_HOST = '127.0.0.1';
  process.env.XDN_IMAGE_OPTIMIZER_PORT = jsPort; // needed for ResponseWriter.serveStatic to know how to contact the static asset server

  process.env.XDN_CONFIG = JSON.stringify({
    backends: {
      __static__: {
