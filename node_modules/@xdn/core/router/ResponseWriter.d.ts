...
import { BaseResponseWriter } from './BaseResponseWriter';
/**
...
export default class ResponseWriter extends BaseResponseWriter {
     ...
     * @param options
     */
    proxyHost: (backendConfig: BackendOptions, { path, transformRequest, transformResponse, headers }?: ProxyOptions) => Promise<void>;
    /**
...
export interface ServeStaticOptions {
     ...
     * the XDN will instantly serve a loading page while computing a server-side rendered result for future requests.
