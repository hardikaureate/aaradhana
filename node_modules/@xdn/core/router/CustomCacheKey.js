...
var CustomCacheKey = /** @class */ (function () {
     ...
     */
    CustomCacheKey.prototype.clone = function () {
        var newKey = new CustomCacheKey();
     ...
     */
    CustomCacheKey.prototype.removeMethod = function () {
        this.actions.push(function (key, srcRequest) {
     ...
     * @return A self-reference, suitable for chaining.
     */
    CustomCacheKey.prototype.removeBody = function () {
        this.actions.push(function (key, srcRequest) {
            key.body = undefined;
        });
        this.config.push({
    ...
    CustomCacheKey.prototype.getActions = function () {
        return this.actions;
    };
