...
var RouteGroupList = /** @class */ (function () {
    ...
    /**
     * This method is for clearing all previous fallbacks in router, before adding a new one.
     * This way we can override package specific fallbacks(next).
     *
     * @private
     */
    RouteGroupList.prototype.clearFallbacks = function () {
        this.routeGroups = this.routeGroups.filter(function (group) { return group.name !== 'fallback'; });
        return this;
    };
