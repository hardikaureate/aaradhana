...
export interface CacheOptions {
     ...
     * `x-xdn-upstream-requests` header.
     */
...
export interface BrowserCacheOptions {
     ...
     *
     * When `true`, the service worker will add the request body as the `pref_xdn_body` parameter.
     ...
     *
     * @private - Until we ensure that the xdn_head requests are viable
     */
    spa?: boolean;
}
