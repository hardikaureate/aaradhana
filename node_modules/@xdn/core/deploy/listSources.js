 ...
 * @param sourcesConfig The value of the sources config in xdn.config.js
 * @private
 */
function listSources(appDir, sourcesConfig) {
    return __awaiter(this, void 0, void 0, function () {
        var globs;
        return __generator(this, function (_a) {
            globs = (sourcesConfig || ['**/*']).concat('!node_modules', '!.env');
            return [2 /*return*/, globby_1.sync(globs, { gitignore: true, cwd: appDir })];
        });
    });
}
