...
export default class DeploymentBuilder {
     ...
     * @return A self reference, suitable for chaining
     */
    addDefaultXdnScripts(scriptsOverride?: {}, overrideExisting?: boolean): this;
    /**
     * Copies a file
    ...
    readFileSync(path: string, { encoding }?: {
        encoding?: "base64" | "ascii" | "utf8" | "utf-8" | "utf16le" | "ucs2" | "ucs-2" | "latin1" | "binary" | "hex" | undefined;
    }): string;
    /**
     * Deletes a file
