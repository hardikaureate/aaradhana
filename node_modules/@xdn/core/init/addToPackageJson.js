 ...
 * @param contents The config to add
 * @param overwrite True to overwrite any values that already exist in the package.json file
 * @return The resulting package.json contents as an object
 */
function addToPackageJson(contents, overwrite) {
    if (overwrite === void 0) { overwrite = true; }
    var file = path_1.join(process.cwd(), 'package.json');
    var packageContents = JSON.parse(fs_1.readFileSync(file, 'utf8'));
    packageContents = overwrite ? merge_1.default(packageContents, contents) : merge_1.default(contents, packageContents);
