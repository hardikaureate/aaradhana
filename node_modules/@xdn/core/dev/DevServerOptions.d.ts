...
export default interface DevServerOptions {
    ...
    /**
     * An array of regular expressions to search for in application server output. Once all have been
     * matched, The "MOOVWEB XDN ready on http://127.0.0.1:3000" line will be displayed.
     */
    ready?: RegExp[];
    /**
