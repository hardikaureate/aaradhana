...
/**
 * Used to determine if the app is running in `xdn run` development environment
 * @returns `true` when running with `xdn run`without production flag, `false` otherwise
 */
export declare function isXdnRunDev(): boolean;
