...
var nonWebpackRequire_1 = __importDefault(require("./nonWebpackRequire"));
...
var Validator = /** @class */ (function () {
    ...
    Validator.validateXdnFileConfiguration = function (config) {
        ...
        var Ajv = nonWebpackRequire_1.default('ajv');
        var ajv = new Ajv({
            allErrors: true,
        ...
        if (has_1.default(config, 'backends.moov')) {
        ...
        if (has_1.default(config, "backends." + constants_1.BACKENDS.static)) {
            errors.push({
                message: 'is a reserved backend name',
                // eslint-disable-next-line quotes
        ...
        if (has_1.default(config, "backends." + constants_1.BACKENDS.js)) {
            errors.push({
                message: 'is a reserved backend name',
                // eslint-disable-next-line quotes
