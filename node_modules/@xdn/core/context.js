...
function withContext(cb) {
    if (environment_1.isLocal()) {
        ...
        global.__xdn_timings__ = new SingletonContext();
        return cb();
    }
}
 ...
 */
function getContext() {
    return global.__xdn_timings__ || getClsNamespace();
}
/**
 * Creates a new CLS-hooked namespace
 */
function createClsNamespace() {
    var cls = nonWebpackRequire_1.default('cls-hooked');
    if (!clsNamespace) {
 ...
 *
 */
var SingletonContext = /** @class */ (function () {
    function SingletonContext() {
        this.values = {};
    }
    SingletonContext.prototype.get = function (key) {
        return this.values[key];
    };
    SingletonContext.prototype.set = function (key, value) {
