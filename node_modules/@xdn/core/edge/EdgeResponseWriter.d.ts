...
import { ProxyOptions, RedirectOptions, ServeStaticOptions } from '../router/ResponseWriter';
...
export default class EdgeResponseWriter extends ResponseWriter {
     ...
     */
    serveStatic: (path: string, { permanent, exclude, onNotFound, loadingPage, expiresSeconds }?: ServeStaticOptions) => Promise<void>;
    /**
