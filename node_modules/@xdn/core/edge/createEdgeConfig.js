...
var convertStringMatcherToRegex_1 = __importDefault(require("../utils/convertStringMatcherToRegex"));
...
function buildMatcherFromRoute(route) {
    var match = [];
    var matchProtocolJavaScriptRegExpSource;
    ...
    return {
        ...
        matchProtocolJavaScriptRegExpSource: matchProtocolJavaScriptRegExpSource,
    };
}
/**
...
function createDestination(router) {
    return __awaiter(this, void 0, void 0, function () {
        var faultyRoutes, destination, _a, errorMessage_1;
        var _this = this;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Promise.all(router
                            ...
                            var writer, e_1, _a, match, matchExplicitMethod, matchProtocolJavaScriptRegExpSource;
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                    ...
                                    case 3:
                                        e_1 = _b.sent();
                                        Error.captureStackTrace(e_1);
                                        faultyRoutes.push({
                                            route: route.toString(),
                                            stackTrace: e_1.stack,
                                        });
                                        return [3 /*break*/, 4];
                                    case 4:
                                        _a = buildMatcherFromRoute(route), match = _a.match, matchExplicitMethod = _a.matchExplicitMethod, matchProtocolJavaScriptRegExpSource = _a.matchProtocolJavaScriptRegExpSource;
                                        return [2 /*return*/, {
                ...
                case 1:
                    ...
                    if (faultyRoutes.length) {
                        ...
                        faultyRoutes.forEach(function (_a) {
                            var route = _a.route, stackTrace = _a.stackTrace;
                            errorMessage_1 = errorMessage_1.concat("\n* " + route + ": " + stackTrace);
                        });
