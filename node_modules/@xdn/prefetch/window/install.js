...
function install(options) {
    return __awaiter(this, void 0, void 0, function () {
        var spaRoutes, serviceWorker, prefetchURLs, watch, _a, serviceWorkerPath, cacheManifest, prefetchPatterns;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    prefetchURLs = options.prefetchURLs, watch = options.watch, _a = options.serviceWorkerPath, serviceWorkerPath = _a === void 0 ? '/service-worker.js' : _a;
                    return [4 /*yield*/, loadManifest_1.default({ cacheHost: options.cacheHost })];
                case 1:
                    _b.sent();
                    cacheManifest = CacheManifest_1.default.fromEntries(
                    // @ts-ignore
                    window.__XDN_CACHE_MANIFEST__ || []);
                    prefetchPatterns = __spread((options.prefetchPatterns || [])).map(function (routeRegex) { return ({
                    ...
                    watchLinks_1.default(cacheManifest);
